...
def base_train_args(parser):
    ...
    group.add_argument('--lr', default=0.02, type=float,
                       help='learning rate')
    group.add_argument('--sch-intervals', nargs='*', default=[30,40], type=int,
    ...
    group.add_argument('--model_dir', type=str,
                        default='./frize_distill_unlabel_avg_pool_15__18_node_9_69.5199966430664.pth.tar')
